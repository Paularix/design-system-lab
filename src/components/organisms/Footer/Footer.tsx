...
interface FooterProps {
  ...
  title?: string;
  /** Message displayed when the user scrolls up (exit intent) */
  exitMessage?: string;
  /** Icon shown inside the exit intent bubble */
  exitIcon?: ReactNode;
  /** Target email address for the contact button */
  email?: string;
  /** Full URL for the LinkedIn profile */
  linkedInUrl?: string;
  /** Small text at the very bottom of the footer */
  footerNote?: string;
}

/**
 * A smart footer component with scroll-tracking and inactivity triggers.
 * It features an "Exit Intent" notification and subtle pulsing animations 
...
export const Footer = ({ 
  ...
  // Scroll Tracking for Exit Intent
  useEffect(() => {
    const handleScroll = () => {
      const currentScrollY = window.scrollY;
      // If user is in footer and scrolls up, show the message
